...
| 2.  | [Анализ структуры и активности клиентов (жертвователей) благотворительного фонда "Синдром Любви"]([https://github.com/MetalTheOwl/portfolio/tree/main/da_ds_hh_vacancies_analysis](https://github.com/MetalTheOwl/portfolio/tree/main/BFSindromLubvi)) | Анализ структуры и активности клиентов (жертвователей) благотворительного фонда, на основании предоставленных выгрузок данных из CRM-системы | python, pandas, matplotlib, numpy|
